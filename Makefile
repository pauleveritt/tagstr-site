...
# 	sed -i.bak 's|<head>|<head><script src="coi-serviceworker.min.js"></script>|' playground/dist/index.html && rm playground/dist/index.html.bak
# 	sed -i.bak 's|<head>|<head><script src="../coi-serviceworker.min.js"></script>|' playground/dist/lab/index.html && rm playground/dist/lab/index.html.bak
